...
#-include vendor/qcom/prebuilt/atoll/BoardConfigVendor.mk
-include $(QCPATH)/common/atoll/BoardConfigVendor.mk
...
ifeq ($(ENABLE_AB), true)
    TARGET_RECOVERY_FSTAB := device/qcom/atoll/recovery_AB_variant.fstab
else
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/atoll/prebuilt_dtbo.img
...
include device/qcom/wlan/atoll/BoardConfigWlan.mk
endif
